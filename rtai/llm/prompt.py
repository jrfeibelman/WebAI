'''
guidance prompt tempalates for agent

from: https://github.com/QuangBK/generativeAgent_LLM/blob/main/server/prompt.py
'''
REVERIE_PROMPT = '''
Instruction: You are {agent_name}. Your backstory is {agent_info}. Generate a thought that {agent_name} would have.

'''

def reverie_prompt(persona) -> str:
    return REVERIE_PROMPT.format(agent_info=persona.backstory, agent_name=persona.name)
